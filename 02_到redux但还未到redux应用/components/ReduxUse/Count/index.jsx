/*
 实现异步action：要想使用请开启：index.js的store.subscribe代码
 */
...
export default class Count extends Component {
    ...
    incrementIfodd=()=>{
        ...
        if(store.getState()%2!==0){
            store.dispatch(createIncrementAction(parseInt(num),500))
        }
    ...
    incrementAsync=()=>{
        let num = this.selectNum.value
        store.dispatch(createIncrementAsyncAction(parseInt(num),500))
    }
    render() {
        return (
            <div>
